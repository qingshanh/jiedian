// ==UserScript==
// @name         Coomer 佬友严选 (移动端优化版)
// @namespace    http://tampermonkey.net/
// @version      1.0.1
// @description  OnlyFans 赛博菩萨，佬友严选，值得信赖！移动端优化 - 触摸友好、响应式设计、虚拟键盘自适应。艺术家收藏、作品管理、视频播放。
// @author       urzeye; 移动端优化: AI助手
...
// @downloadURL https://update.greasyfork.org/scripts/559828/Coomer%20%E4%BD%AC%E5%8F%8B%E4%B8%A5%E9%80%89.user.js
// @updateURL https://update.greasyfork.org/scripts/559828/Coomer%20%E4%BD%AC%E5%8F%8B%E4%B8%A5%E9%80%89.meta.js
// ==/UserScript==
...
(function () {
    ...
    const DEFAULT_SETTINGS = {
        ...
        fabPosition: { right: 12, bottom: 80 },
    ...
    const ViewportManager = {
        init() {
            ...
            if (!viewport) {
                ...
                viewport.content = 'width=device-width, initial-scale=1.0, viewport-fit=cover, user-scalable=yes, maximum-scale=5';
            ...
            if (isMobile()) {
                ...
                window.addEventListener('resize', () => {
                    ...
                    if (heightDiff > 50) {
                        ...
                        // 面板滚动到顶部，防止被键盘遮挡
                        const panelContent = document.querySelector('.coomer-panel-content');
                        if (panelContent) {
    ...
    const UIPanel = {
        ...
        injectStyles() {
            ...
            GM_addStyle(`
                ...
                .coomer-fab {
                    ...
                    border: 2px solid var(--coomer-primary);
                    cursor: pointer;
                ...
                .coomer-panel-header {
                    ...
                    border-bottom: 2px solid var(--coomer-primary);
                    border-radius: 24px 24px 0 0;
                }
                @media (min-width: 1024px) {
                    .coomer-panel-header {
                ...
                .coomer-card:active .coomer-card-img {
                ...
                .coomer-video-item:active .coomer-video-icon {
                    background: var(--coomer-primary);
                    color: #000;
                    transform: scale(1.1);
                }
                ...
                .coomer-btn-primary:active {
                    background: var(--coomer-primary-hover);
                }
                .coomer-btn-danger {
                    background: transparent;
                    border: 2px solid var(--coomer-danger);
                    color: var(--coomer-danger);
                }
                .coomer-btn-danger:active {
                    background: var(--coomer-danger);
                    color: white;
                }
        ...
        createFloatingButton() {
            ...
            fab.addEventListener('click', (e) => {
                ...
                // 在移动端，FAB的第一次点击显示快捷操作
                // 第二次点击才打开面板，这样交互更合理
                if (isMobile() && this.quickActions && !this.quickActions.classList.contains('show')) {
                    // 快捷操作还未显示，先显示它
                    return;
                }
                this.toggle();
        ...
        createQuickActions() {
            ...
            if (pageType === 'artist' || pageType === 'post') {
                ...
                collectArtistBtn.innerHTML = isArtistCollected ? '✓ 已藏艺术家' : '👤 艺术家';
            ...
            if (pageType === 'post') {
                ...
                collectPostBtn.innerHTML = isPostCollected ? '✓ 已藏作品' : '🎬 作品';
            ...
            if (container.children.length > 0) {
                ...
                if (!isMobile()) {
                    ...
                    document.addEventListener('click', (e) => {
                        if (!container.contains(e.target) && e.target !== this.fab) {
                            container.classList.remove('show');
                        }
                    });
                }
